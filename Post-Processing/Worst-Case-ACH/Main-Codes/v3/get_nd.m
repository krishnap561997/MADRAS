function n_d = get_nd(n_wm,ACH,eta_ef,d)
...
fpath = '/home/krishnap.kalivel/MATLAB_src/Higher-ACH-Better/Main-Codes/v3/Data';
...
t_adj = t0.*5/ACH;
t = 0:round(max(t_adj));
gamma = interp1(t_adj,gamma2,t,'pchip','extrap');
