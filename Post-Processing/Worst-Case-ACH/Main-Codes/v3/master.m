...
ACH_min = 0.3;
ACH_max = 30;
parentFolder = '/blue/bala/krishnap.kalivel/COVID/HigherACHBetter/dist4m/temp';
for i=0:dT1_max
    for j=0:dT2_max
        ...
        fprintf(fid,"'/blue/bala/krishnap.kalivel/COVID/HigherACHBetter/dist4m/Data_T0'");
        fprintf(fid,'\n');
        ...
        copyfile('/home/krishnap.kalivel/MATLAB_src/Higher-ACH-Better/Main-Codes/v3/main_v3','main_v3')
        copyfile('/home/krishnap.kalivel/MATLAB_src/Higher-ACH-Better/Main-Codes/v3/run.sh','run.sh')
        cd('/blue/bala/krishnap.kalivel/COVID/HigherACHBetter/dist4m/temp');
        if(i==0 && j==0)
