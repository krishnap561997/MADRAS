function [r, n_so,Qb] = choose_activity_HPG(activity,rc,fpath)

% fpath = 'C:\Users\krishnap.kalivel\University of Florida\COVID-19 - NSF - First Paper\Krishna\Part 5\Evaluate n inf\Nadim Excel Files - n_so';
...
M = readmatrix(fullfile(fpath,text));
r_digitized = M(:,1);
phi_s_digitized = M(:,2);
