...
time_gap = 200;
parentFolder ='/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_v2/room_34/dist_1m/dp10micron/temp';
nxt = 25;    nyt = 8;     nzt = 25;
rlenx = 10; rleny = 3.2; rlenz = 10;
sphere_diameter = 0.4; dist = 0.98; tolerance = 0;
for i=1:nxt
    for j=1:nyt
        for k=1:nzt
            ...
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_v2/room_34/dist_1m/dp10micron/Data'");
            fprintf(fid,'\n');
            fprintf(fid,"'/orange/bala1s/krishnap.kalivel/COVID/room_34/id_dp_tm'");
            fprintf(fid,'\n');
            ...
            copyfile('/home/krishnap.kalivel/MATLAB_src/Aerosol-Paper/Source-Sink-v2-dp/main_sou2snk_v3','main_sou2snk_v3')
            copyfile('/home/krishnap.kalivel/MATLAB_src/Aerosol-Paper/Source-Sink-v2-dp/run.sh','run.sh')
            cd('/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_v2/room_34/dist_1m/dp10micron/temp');
            if(i==1 && j==1 &&  k==1)
