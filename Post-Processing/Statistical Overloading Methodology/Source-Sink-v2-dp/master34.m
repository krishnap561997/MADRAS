...
time_limit_min = 2478;
time_gap = 200;
parentFolder ='/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_v2/room_34/dist_0.4m/temp';
nxt = 25;    nyt = 8;     nzt = 25;
rlenx = 10; rleny = 3.2; rlenz = 10;
sphere_diameter = 0.4; dist = 0.4; tolerance = 0;
for i=1:nxt
    for j=1:nyt
        for k=1:nzt
            ...
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_v2/room_34/dist_0.4m/Data'");
            fprintf(fid,'\n');
            ...
            cd('/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_v2/room_34/dist_0.4m/temp');
            if(i==1 && j==1 &&  k==1)
