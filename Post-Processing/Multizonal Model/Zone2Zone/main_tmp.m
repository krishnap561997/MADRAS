...
% C = textscan(fileID,'%s %s %f %f %f %f %f %f %f %f','Delimiter','\n');
...
[id_src0, dp_src0, loc_src0] = load_srczone_data(fpath, start_t, Z_src, rlenx, rlenz, outlet_c);
toc
fprintf('\n')
...
disp('-----------------------------------')
disp('Saving Data')
sname = strcat(['IZData_Zone_',num2str(Z_src),'_t_',num2str(start_t),'s.mat']);
