...
nfile = 3612;
time_gap = 60;
parentFolder ='/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_SFR/room_31/dist_8m/dt_060s/temp';
nxt = 25;    nyt = 8;     nzt = 25;
rlenx = 10; rleny = 3.2; rlenz = 10;
sphere_diameter = 0.4; dist = 8; tolerance = 0.02;
for i=1:nxt
    for j=1:nyt
        for k=1:nzt
            ...
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_SFR/room_31/dist_8m/dt_060s/Data'");
            fprintf(fid,'\n');
            fprintf(fid,"'/orange/bala1s/krishnap.kalivel/COVID/room_31/id_dp_tm'");
            fprintf(fid,'\n');
            ...
            copyfile('/home/krishnap.kalivel/MATLAB_src/Aerosol-Paper/Source-Sink-SFR/main_sou2snk_sfr','main_sou2snk_sfr')
            copyfile('/home/krishnap.kalivel/MATLAB_src/Aerosol-Paper/Source-Sink-SFR/run.sh','run.sh')
            cd('/blue/bala1s/krishnap.kalivel/COVID/Sou2Snk_SFR/room_31/dist_8m/dt_060s/temp');
            if(i==1 && j==1 &&  k==1)
