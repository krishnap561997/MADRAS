...
time_limit_min = 1611;
time_gap = 50;
parentFolder ='/blue/bala1s/krishnap.kalivel/StatOverload/AccumulationTime/room_31/dist_1m/t50/temp';
nxt = 25;    nyt = 8;     nzt = 25;
...
for i=1:nxt
    for j=1:nyt
        for k=1:nzt
            ...
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/StatOverload/AccumulationTime/room_31/dist_1m/t50/Data'");
            fprintf(fid,'\n');
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/COVID/room_31/id_dp_tm'");
            fprintf(fid,'\n');
            ...
            cd('/blue/bala1s/krishnap.kalivel/StatOverload/AccumulationTime/room_31/dist_1m/t50/temp');
            if(i==1 && j==1 &&  k==1)
