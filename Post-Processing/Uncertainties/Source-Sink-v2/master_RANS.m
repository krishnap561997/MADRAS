...
time_limit_min = 1818;
time_gap = 50;
parentFolder ='/blue/bala1s/krishnap.kalivel/RANS/RANS_room0/Sou2Snk/dist_4m/temp';
nxt = 25;    nyt = 8;     nzt = 25;
rlenx = 10; rleny = 3.2; rlenz = 10;
sphere_diameter = 0.4; dist = 3.99; tolerance = 0.02;
for i=1:nxt
    for j=1:nyt
        for k=1:nzt
            ...
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/RANS/RANS_room0/Sou2Snk/dist_4m/Data'");
            fprintf(fid,'\n');
            fprintf(fid,"'/blue/bala1s/krishnap.kalivel/RANS/RANS_room0/id_dp_tm'");
            fprintf(fid,'\n');
            ...
            cd('/blue/bala1s/krishnap.kalivel/RANS/RANS_room0/Sou2Snk/dist_4m/temp');
            if(i==1 && j==1 &&  k==1)
