...
path =  '/blue/bala/krishnap.kalivel/COVID/Sou2Snk_Spheres/dist_8m/room_27/Data'

addpath(genpath(path))

fpath = '/blue/bala/krishnap.kalivel/COVID/Sou2Snk_Spheres/dist_8m/room_27/Figures'
