...
nfile = 1813;
time_limit = 1600;
parentFolder ='/blue/bala/krishnap.kalivel/COVID/Sou2Snk_Spheres/dist_3.5m/room_30/temp';
nxt = 25;    nyt = 8;     nzt = 25;
rlenx = 10; rleny = 3.2; rlenz = 10;
sphere_diameter = 0.4; dist = 3.5; tolerance = 0.01;
for i=1:nxt
    for j=1:nyt
        for k=1:nzt
            ...
            fprintf(fid,"'/blue/bala/krishnap.kalivel/COVID/Sou2Snk_Spheres/dist_3.5m/room_30/Data'");
            fprintf(fid,'\n');
            ...
            copyfile('/home/krishnap.kalivel/MATLAB_src/Post-Processing/Source-Sink/main_sou2snk','main_sou2snk')
            copyfile('/home/krishnap.kalivel/MATLAB_src/Post-Processing/Source-Sink/run.sh','run.sh')
            cd('/blue/bala/krishnap.kalivel/COVID/Sou2Snk_Spheres/dist_3.5m/room_30/temp');
            if(i==1 && j==1 &&  k==1)
